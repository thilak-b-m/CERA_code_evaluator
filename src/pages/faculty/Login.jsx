...
export default function Login() {
  ...
  const handleSubmit = (e) => {
     ...
     * backend authentication API later.
     */
    ...
    setTimeout(() => {
      try {
        ...
        notify(
          'Signed in to CERA successfully'
        );
    ...
    <div className="auth-layout">
      ...
      <div className="auth-visual">
        ...
        <div>
          ...
          >
            The command center for faculty
            who want every lab, submission,
            and learning signal in reach.
          </p>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <p className="page-subtitle">
              Sign in to your CERA workspace.
            </p>
          </div>
